...
def AdminOffers():
    print (f"[ {Y}OPTOIN{W} ] : {LB}Raihan ( Raihan Khan ) - Services{W}")
    print ("================================================")
    ...
    {LB}You can contact me through only one place and that is my account on Instagram @theraihhan{W}

    [ {B}Link{W} ] : https://pinksurfing.com/
